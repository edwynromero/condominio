...
/**
 * This is the model base class for the table "r_auth_assignment".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "AuthAssignment".
 *
 * Columns in table "r_auth_assignment" available as properties of the model,
...
abstract class BaseAuthAssignment extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('userid, bizrule, data', 'default', 'setOnEmpty' => true, 'value' => null),
