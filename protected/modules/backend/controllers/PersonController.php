	...
	public function actionCreateAjax()
	{
		...
		if(isset($_POST['Person']))
		{
			...
			if($model->save())
			{
				...
				CHtml::encode($model->FullNameList),true);
				echo CHtml::tag("script",array(), '$("#Owner_person_id").append(\''. $option . '\'); jQuery("#createPersonDialog").dialog("close");');
				Yii::app()->end();
			}
		}
		else
		...
		$this->renderPartial('ajax/create',array(
				'model'=>$model,
		),false,true);
	}	
