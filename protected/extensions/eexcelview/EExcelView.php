...
Yii::import('zii.widgets.grid.CGridView');
	...
	*/	
	...
	{
		// PHP Excel Path
		public static $phpExcelPathAlias = 'application.vendors.phpexcel.Classes.PHPExcel';
		...
		public function renderRow($row)
		{
			...
			foreach($this->columns as $n=>$column):
				...
				if($c1==3 && (is_numeric( $dateF[0]) && $dateF[0]<9000) && ( is_numeric( $dateF[1]) && $dateF[1]<13) && (is_numeric( $dateF[2]) && $dateF[2]<32))//{}
